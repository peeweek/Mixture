Shader "Hidden/MixtureTexture3DPreview"
{
	Properties
	{
		_PreviewTexture("_PreviewTexture", 3D) = "" {}
		...
		SubShader
		{
			...
			Pass
			{
				...
				float4 frag(v2f i) : SV_Target
				{
					...
					float4 color = tex3Dlod(_PreviewTexture, float4(i.uv, _Slice / _Size.z, floor(_PreviewMip))) * _Channels;
